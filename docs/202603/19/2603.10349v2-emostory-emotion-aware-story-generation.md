...
authors: "Jingyuan Yang, Rucong Chen, Weibin Luo, Hui Huang"
date: 2026-03-11
pdf: "https://arxiv.org/pdf/2603.10349v2"
tags: ["query:llm-ac"]
score: 7.0
evidence: 情感感知生成与叙事解读
...
## 摘要
故事生成旨在生成描绘连贯叙事的图像序列，同时在不同帧之间保持主体一致性。尽管现有方法在生成连贯且富有表现力的故事方面表现出色，但它们在很大程度上仍保持情感中立，侧重于故事中出现的主体，而忽视了情感如何塑造叙事解读和视觉呈现。鉴于故事旨在引起观众的情感共鸣，我们引入了情感感知的故事生成，这是一项旨在生成具有明确情感导向且主体一致的视觉故事的新任务。由于情感的抽象性，该任务具有挑战性，情感必须植根于具体的视觉元素，并通过视觉构图在整个叙事中保持一致的表达。为了应对这些挑战，我们提出了 EmoStory，这是一个集成了基于智能体（agent-based）的故事规划和区域感知（region-aware）故事生成的两阶段框架。规划阶段通过情感智能体和作家智能体将目标情感转化为连贯的故事提示词，而生成阶段则通过区域感知构图保持主体一致性并注入情感相关元素。我们在一个新构建的数据集上评估了 EmoStory，该数据集涵盖了 25 个主体和 600 个情感故事。广泛的定量和定性结果以及用户研究表明，EmoStory 在情感准确性、提示词对齐和主体一致性方面优于最先进的故事生成方法。
