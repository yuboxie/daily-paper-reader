...
date: 2026-03-12
pdf: "https://arxiv.org/pdf/2603.11408v2"
tags: ["query:llm-ac"]
score: 6.0
evidence: 用于预测任务的多维大语言模型情感信号
tldr: 本研究探讨了利用大语言模型（LLM）提取多维情绪信号以预测WTI原油期货周收益率。研究基于2020-2025年的能源新闻，利用GPT-4o等模型构建了包含相关性、极性、强度、不确定性和前瞻性的五维情绪指标。结果表明，结合LLM与传统金融情绪模型能显著提升预测性能，且强度和不确定性维度比单一极性更具预测价值，为能源市场风险监控提供了新工具。
selection_source: fresh_fetch
motivation: 传统基于极性的情绪指标难以充分捕捉非结构化新闻中影响原油价格的复杂信息。
method: 利用GPT-4o、Llama 3.2等模型从能源新闻中提取五维情绪信号，并结合FinBERT在分类框架下评估其对WTI期货收益的预测能力。
result: GPT-4o与FinBERT的组合模型表现最优，SHAP分析证实了强度和不确定性特征在预测中的关键作用。
conclusion: 多维LLM情绪指标能有效提升大宗商品收益预测精度，为能源市场风险监控提供有力支持。
---
